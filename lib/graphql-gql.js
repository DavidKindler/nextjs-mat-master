...
`
export const ONE_APP_QUERY = gql`
  query App($appInput: AppInput!) {
    app(input: $appInput) {
      _id
      app
      url
...
`
export const UPDATE_APP_URL = gql`
  mutation UpdateAppUrl($newUrl: UpdateAppUrlInput!) {
    updateAppUrl(input: $newUrl) {
      _id
      app
      url
      roles
...
export const UPDATE_APP_ROLES = gql`
  mutation updateAppRoles($appRoles: UpdateAppRolesInput!) {
    updateAppRoles(input: $appRoles) {
      _id
      app
      url
      roles
